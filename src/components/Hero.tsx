      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left max-w-3xl mx-auto lg:mx-0 animate-fade-up">
            <div className="inline-block mb-3 px-3 py-1 bg-primary/10 rounded-full text-primary text-sm font-medium border border-primary/20 glow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="bg-primary hover:bg-primary/90 transition-colors relative overflow-hidden group neon-glow">
          ...
          <div className="flex-1 relative animate-fade-up" style={{animationDelay: "0.2s"}}>
            <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden animate-float shadow-[0_0_30px_rgba(138,86,255,0.3)] card-glow">
              <img 
              ...
              {/* Glass card */}
              <div className="absolute bottom-6 left-6 right-6 glass-effect p-5 rounded-xl border border-white/10">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-primary/20 rounded-full blur-xl opacity-60"></div>
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-cyan-400/20 rounded-full blur-2xl opacity-50"></div>

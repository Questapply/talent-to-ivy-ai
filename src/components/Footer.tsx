    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">QuestApply</h3>
            <p className="text-gray-400 text-sm">
              Discover your talents and connect with top universities through our AI-powered platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Chat with AI</a></li>
